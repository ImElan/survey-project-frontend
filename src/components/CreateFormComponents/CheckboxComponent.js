...
function CheckboxComponent(props) {
  ...
  const [options, setOptions] = useState([{ optionId: 0, option: "option1" }, { optionId: 1, option: "option2" }, { optionId: 2, option: "option3" }]);
  ...
  return (
    ...
    <div className="App">
      ...
      <div className="mt-5">
        <input className="form-control" value={initial} type="text" placeholder="Question" size="50" maxLength="100" onChange={handleChange} onBlur={checkValid} />
        <br />
        <br />
